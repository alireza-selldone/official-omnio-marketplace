...
const PAGES = {
  "about-us": ["About Omnio", "How Omnio organises its fashion catalogue and helps customers choose with confidence."],
...
/* Brands is data-driven rather than Markdown-driven, but it uses the exact same
   ...
   catalogue without baking Omnio's current brand names into the page. */
