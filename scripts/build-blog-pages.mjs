...
const PAGES = [
  {
    file: "blog.html",
    script: "blog.js",
    title: "Buying Guides — Omnio",
    desc: "Practical Omnio guides for styling, fitting, and caring for an everyday wardrobe.",
    main: `<main id="main" tabindex="-1">

        <section class="pghead ink">
          <div class="wrap">
            <p class="eyebrow eyebrow--onink">Omnio insights</p>
        ...
        <section class="section">
          <div class="wrap">
            ...
            <div class="sempty" data-blog-empty hidden>
              ...
              <p class="cap">New Omnio buying guides will appear here.</p>
            </div>
          </div>
        </section>
...
`,
  },
  {
    ...
    script: "article.js",
    title: "Buying Guides — Omnio",
    desc: "A practical fashion and wardrobe guide from Omnio.",
    main: `<main id="main" tabindex="-1">
        ...
        <article data-article>
          <section class="pghead ink">
            <div class="wrap">
              <div class="pgcol">
                <p class="eyebrow eyebrow--onink" data-article-cat>Omnio guide</p>
